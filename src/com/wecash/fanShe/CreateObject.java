...
/**
 * Created by chengtong on 2018/1/5.
 */
public class CreateObject {
    ...
    public static void createObj1() throws Exception {
        ...
        Class classType = Class.forName("com.wecash.fanShe.Car");
    ...
    public static void createObj2() throws Exception {
        ...
        Class classType = Car.class;

        @SuppressWarnings("unchecked")
        Constructor<Car> con = classType.getConstructor(String.class,String.class,
                int.class);
        Object obj = con.newInstance("港仔","大奔", 23);
    ...
    public static void methodDo() throws Exception {
        Car p = new Car();
        Class classType = Car.class;
        Method method = classType.getMethod("setColor", String.class);
        method.invoke(p, "大白");
        System.out.println("使用反射操作SetName方法后,Car对象的color值是：" + p.getColor());

        Method method2 = classType.getDeclaredMethod("getColor");
    ...
    public static void FieldDo() throws Exception {
        Car p = new Car();
        Class classType = Car.class;
        Field field = classType.getDeclaredField("brand");
        Field field2 = classType.getDeclaredField("color");
        field.setAccessible(true);
        field2.setAccessible(true);
        field.set(p, "港仔");
        field2.set(p, "大黄");
        System.out.println("使用反射机制操作被private修饰的对象字段后得到的属性值是：" + p.getBrand());
        System.out.println("使用反射机制操作被private修饰的对象字段后得到的属性值是：" + p.getColor());
    }
